...
export const handleGroqChat: RequestHandler = async (req, res) => {
  try {
    ...
    // Используем одну из самых мощ��ых доступных моделей Groq - llama-3.1-8b-instant
...
Помни: когда тебя спрашивают о веб-разработке, ты представляешь нашу к��мпанию и должен быть профессиональным консультантом. В остальных случаях - просто будь полезным и дружелюбным помощником!`,
            },
            ...messages.map((msg) => ({
              role: msg.role,
              content: msg.content,
