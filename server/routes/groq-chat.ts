      ...
      "https://api.groq.com/openai/v1/chat/completions",
      {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: "system",
              content: `Ты - Пятница, ИИ-ассистент. ВСЕГДА отвечай ТОЛЬКО на русском языке, независимо от языка вопроса. Отвечай кратко и дружелюбно. Никогда не используй другие языки в ответах.`,
            },
            ...messages.map((msg) => ({
              role: msg.role,
              content: msg.content,
