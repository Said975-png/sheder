  ...
  try {
    ...
    if (!groqApiKey) {
      ...
      if (
        ...
        fallbackMessage =
          "🤖 Пятница здесь! Работаю в демо-режиме. Могу рассказать о наш��х услугах веб-разработки и тарифах. Что вас интересует?";
      }
...
- Отвечай подробно на в��просы о веб-разработке и наших услугах
