...
export default function VoiceMicrophone({
  ...
  const handleCommand = (command: string) => {
    ...
    if (
      ...
      console.log(
        "🎯 Команда '��жарвис смени модель' получена - восп��оизводим аудио и меняем модель",
      );
    ...
    if (
      ...
      console.log("🎯 Команда 'джарвис полный доступ' получена - активируем режим Старка");
      playAudioWithCallback(
    ...
    if (
      ...
      console.log("🙏 Команда благодар��ости получена");
    } else if (
