...
export default function VoiceControl({
    ...
    if ("webkitSpeechRecognition" in window || "SpeechRecognition" in window) {
      ...
      if (recognitionRef.current) {
        ...
        recognitionRef.current.onresult = (event) => {
          ...
          if (
            ...
            if (
              ...
              ); // Мень��е за��ержки дл�� ��и��альных результатов
            } else {
        ...
        recognitionRef.current.onerror = (event) => {
          ...
          if (event.error === "network") {
            ...
            setTimeout(() => {
              if (isListening && recognitionRef.current) {
                ...
                try {
                  recognitionRef.current.start();
                  console.log("✅ Распознавание восста��овлено");
          ...
          // Другие оши��ки - ����резапускаем через корот���ое вр��мя
          else {
            console.warn(
  ...
  const speakWelcomeBack = () => {
    ...
    audio.play().catch((error) => {
      ...
      console.error("Не уд��лось восп��ои��вести аудио приветствия:", error);
    });
  };
  ...
  const speakHowAreYou = () => {
    ...
    if ("speechSynthesis" in window) {
      ...
      utterance.lang = "en-US"; // ��нг��ийский дл�� лучшего качества, потом переклю�����им ���� русский
  ...
  const speakCorrect = () => {
    ...
    audio.onerror = () => {
      resetState();
      console.error("❌ ��шибка воспроизведени�� втор��го аудио");
    };
    ...
    firstAudio.onended = () => {
      ...
      setTimeout(() => {
        ...
        secondAudio.onended = () => {
          ...
          console.log("��� Активац��я лаборатории заверш��на");
        };
  ...
  const processVoiceCommand = (command: string) => {
    ...
    if (
      ...
      command.includes("джарвис как в филь��е") ||
    ...
    if (
      ...
      // До����лнит�����льная проверка, ч��обы избе��������ть повторных срабатываний
    ...
    if (command.includes("заказ") || command.includes("оформ��ть заказ")) {
      navigate("/order");
      speak("Переходи�� �� ��ф��рмл��н��ю зака��а");
      return;
    }
