...
export default function VoiceControl({
  ...
  const speakShutdown = () => {
    ...
    setTimeout(() => {
      ...
      const shutdownComplete = () => {
        ...
        currentAudioRef.current = null;
        setTranscript("");
        // Н�� ��ткрываем панель ��братно после коман��ы отключения
        console.log(
  ...
  const speakGoodMorning = () => {
    ...
    audio.onerror = () => {
      resetState();
      console.error(
        "Ошибка воспроизведения аудио утреннего приветстви��",
      );
    };
  ...
  const processVoiceCommand = (command: string) => {
    ...
    if (
      ...
      // Если ничего сп��цифичного не найдено, пробуем общий поиск
      if (!found) {
    ...
    // Ко��анды доб�����вления пла��ов в корз��н��
    if (
    ...
    // Если дошли до этого места - к��манда не была р��спознан��
