...
export default function VoiceControl({
          ...
          navigator.mediaDevices
            .getUserMedia({
              audio: {
                ...
                // @ts-ignore - Пр��двинутые настройки для лучшего захв��та звука
  ...
  const processVoiceCommand = (command: string) => {
    ...
    // Команда "Джарвис, полна�� активация" - ак��ивация лаборатории Старка
    if (
    ...
    if (
      ...
      command.includes("джарвис из же��езного человека") ||
    ...
    if (
      ...
      console.log(
        "🎯 Команда приветствия ра��познана, време���� прошло:",
