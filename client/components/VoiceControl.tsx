...
export default function VoiceControl({
  ...
  const speak = (text: string) => {
    ...
    // Это ������дотвращает повторно�� открыти�� панели после команды отклю��ен��я
  ...
  // Новая функ��ия для синт��зированного голоса Джарвиса
  ...
  const speakSystemDiagnostics = () => {
    ...
    firstAudio.onended = () => {
      console.log("✅ Пер��ое аудио за��онч��л��сь, ждем 2 секун��ы...");
  ...
  const processVoiceCommand = (command: string) => {
    ...
    if (
      ...
      command.includes("полная активация ��жарвис") ||
    ...
    if (
      ...
      command.includes("жарвис верни меня обратно") ||
    ...
    if (
      ...
      command.includes("джарвис доброе ��тро") ||
    ...
    if (
      ...
      if (
        ...
        console.log(
          "❌ Приветствие заблокировано (��ало времени прошло или и��рает аудио)",
        );
      }
      return;
    }
