...
export default function VoiceControl({
        ...
        try {
          ...
          navigator.mediaDevices
            ...
            .then((stream) => {
              ...
              // Освобождаем поток, ��ак как SpeechRecognition создаст свой
  ...
  const speakWelcomeBack = () => {
    ...
    audio.onerror = () => {
      ...
      console.error("О��ибка воспрои��веден���я ау��������о при��етств��я");
    };
  ...
  const speakGoodMorning = () => {
    ...
    audio.onerror = () => {
      resetState();
      console.error(
        "О��ибка во����произведения ауди�� у��ренне��о при����етствия",
      );
    };
    ...
    firstAudio.onended = () => {
      ...
      setTimeout(() => {
        ...
        secondAudio.onerror = () => {
          resetState();
          console.error(
            "❌ Оши��ка во��произ��едени�� второго ау��ио ��иагн��стики",
          );
        };
  ...
  const speakContinue = () => {
    ...
    audio.play().catch((error) => {
      resetState();
      console.error("❌ Не уд��л��сь восп��оизвести первое аудио:", error);
    });
  };
  ...
  const activateStarkLab = () => {
    ...
    firstAudio.onended = () => {
      ...
      }, 1000); // Задержка 1 секунда для заверше��ия анимации
    };
  ...
  const deactivateStarkLab = () => {
    ...
    const resetState = () => {
      ...
      console.log("✅ Возв��ат к обычно�� теме ��аве��шен");
    };
  ...
  const processVoiceCommand = (command: string) => {
    ...
    if (
      ...
      command.includes("д��вай продолжим") ||
    ...
    // Команда приветствия "Привет Джарвис" - улуч��енное распознавание с защитой от повторов
    if (
      ...
      command.includes("привет жарвис") || // частые оши��ки распознавания
      ...
      // Улучш��нная проверк�� + защита ��т повторов (10 секунд)
      if (
