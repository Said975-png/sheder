...
export default function VoiceControl({
      ...
      if (recognitionRef.current) {
        ...
        if (
          ...
          try {
            ...
            recognitionRef.current.webkitEchoCancellation = false; // ОТКЛЮЧАЕМ для максимальной чувствительности
          ...
          navigator.mediaDevices
            .getUserMedia({
              audio: {
                ...
                googAutoGainControl: true, // ВКЛЮЧАЕ�� автоматическое усиление Google
          ...
          if (
            ...
            if (
              ...
              commandDelayRef.current = setTimeout(
                ...
                finalTranscript ? 50 : 300, // Значительно уменьшаем задержки для быстрого отклика
              ); // Минимальные задержки для максимальной отзывчивости
            } else {
              ...
              // Принудительно очищаем с��стояние для отклоненных ком��нд
              setTimeout(() => {
            ...
            setTimeout(() => {
              if (isListening) {
                ...
                if (started) {
                  ...
                  console.error(
                    "❌ Не удалось во��становить распознавание",
                  );
                }
              }
            }, retryDelay);
  ...
  const speakIAmHere = () => {
    ...
    audio.onerror = () => {
      ...
      console.error("Ошибк�� воспро��з�����ед�����ния аудио о����в��та");
    };
  ...
  const speakWithElevenLabs = async (text: string) => {
    ...
    // О��та��авливаем любое ��екущее вос��р��изв����ени��
    if (currentAudioRef.current) {
      currentAudioRef.current.pause();
      currentAudioRef.current.currentTime = 0;
    }
  ...
  const speakHowAreYou = () => {
    ...
    if ("speechSynthesis" in window) {
      ...
      utterance.rate = 0.75; // Мед����н����я, размеренна�� ����чь как �� Джарвиса из фильма
  ...
  const changeToNewModel = () => {
    ...
    // Добавляем эффект сканера с нео��ом и частицами
  ...
  const activateStarkLab = () => {
    ...
    firstAudio.onended = () => {
      ...
      // Мгно��енно м������яем тему на лабораторию Стар��а
  ...
  const processVoiceCommand = (command: string) => {
    ...
    if (
      ...
      // Пр��нудительно выполняем ко��анду отключени���� независимо от сост����яния
      speakShutdown();
      return;
    }
    ...
    if (
      ...
      console.log("🔬 Кома��да акти��ации лаборатории распознана:", command);
    ...
    if (
      ...
      command.includes("поменяй модель джарви��") ||
    ...
    if (
      ...
      command.includes("да��ай продолжим") ||
    ...
    if (
      command.includes("доб��ое ���тро джарвис") ||
      ...
      if (!isSpeaking && !audioPlayingRef.current && !commandCooldownRef.current &&
        ...
        console.log("❌ Команда 'доброе утро' заблокирована - с��стема зан��та или повтор");
      }
      return;
    }
    ...
    if (
      ...
      command.includes("��ткрыть ��рофиль")
    ) {
      navigate("/profile");
    ...
    console.log("❌ Кома��да не рас��ознана:", command);
        ...
        if (started) {
          ...
          setTimeout(() => {
            ...
            if (retryStarted) {
              ...
              console.log("❌ Повто��ная попытка з��пуска не удалась");
            }
          }, 500);
        }
      }
