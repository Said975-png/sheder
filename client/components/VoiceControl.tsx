...
export default function VoiceControl({
  ...
  useEffect(() => {
    ...
    if ("webkitSpeechRecognition" in window || "SpeechRecognition" in window) {
      ...
      if (recognitionRef.current) {
        ...
        try {
          // @ts-ignore - Настройки для улучш��ния захвата ��ихой речи
            ...
            .then((stream) => {
              ...
              if (audioTracks.length > 0) {
                ...
                track
                  ...
                  .catch((e) =>
                    console.log(
                      "Не удалось применит�� дополнительные ограничения:",
                      e,
                    ),
                  );
              }
            ...
            if (
              ...
              commandDelayRef.current = setTimeout(
                () => {
                  ...
                  setNoSpeechCount(0); // Сбрасываем счетчик пр�� ус��ешном ра��познаван��и
        ...
        recognitionRef.current.onerror = (event) => {
          ...
          // ��ритические ошибки с умным восстановлением
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      // Допо��нительная защита: если система молчит более 5 секунд, ��ринудительно с��ра��ываем
  ...
  const resetCommandState = (
    ...
    setTimeout(() => {
      ...
      console.log("🔄 Полный сброс ��с��х состояний блокировки выполн����");
  ...
  const speakThankYou = () => {
    ...
    audio.onerror = () => {
      ...
      console.error("Ошибка во��п����оизведения ���у��ио бл��годар��о��ти");
    };
  ...
  const speakIAmHere = () => {
    ...
    // Создае�� и во��произво��им аудио для отве��а "��ж��рв��с ты тут?"
    const audio = new Audio(
  ...
  const speakAuthenticJarvis = () => {
    ...
    console.log("���� Нач��наем воспрои��ведение Jarvis аудио");
  ...
  const speakHowAreYou = () => {
    ...
    if ("speechSynthesis" in window) {
      ...
      // Similarity Boost: 90 (высок��е сходс����во с ��ригинальным голосом)
      ...
      // ����сли н�� нашли подходящий а����л��йский, ище�� русский м��жской
  ...
  const deactivateStarkLab = () => {
    ...
    console.log("🔄 Возв��ащаем обычную тему");
    setIsSpeaking(true);
    commandCooldownRef.current = true;
    audioPlayingRef.current = true;
  ...
  const processVoiceCommand = (command: string) => {
    ...
    // При��удите��ьно сбрасываем все блокировки перед обработкой новой ��оманды
    ...
    // Команда "Джарвис давай продолжим" - воспроизводит первое а��дио
    if (
    ...
    // Команды для оригинального голоса Джарвиса (из фи��ьма)
    if (
    ...
    // ��оманда "Джарвис как дела" с ��тветом "Все системы функ��ионируют нормал��но"
    if (
    ...
    console.log("�� Кома��да не ��аспознана:", command);
