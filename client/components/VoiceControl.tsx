...
export default function VoiceControl({
      ...
      if (recognitionRef.current) {
        ...
        recognitionRef.current.onresult = (event) => {
          ...
          if (
            ...
            combinedTranscript.length < 100 && // Фильтр для предотвра��ен��я накопленных транскриптов
  ...
  const speak = (text: string) => {
    ...
    audio.onerror = () => {
      ...
      console.error("Ошибка воспроизв��дения ауди����");
    };
  ...
  const speakWithElevenLabs = async (text: string) => {
    ...
    try {
      ...
      if ("speechSynthesis" in window) {
        ...
        // Последний fallback: п��осто текст в консоли
  ...
  const speakAuthenticJarvis = () => {
    ...
    // Немед��ен����о очищаем тр��нскрипт к��гда н��чинаем говорит��
    setTranscript("");
  ...
  const speakStopModel = () => {
    ...
    audio.onerror = () => {
      resetState();
      console.error("❌ Ош��бка воспроизведения аудио для ��становки модели");
    };
  ...
  const speakHowAreYou = () => {
    ...
    if ("speechSynthesis" in window) {
      ...
      // Similarity Boost: 90 (высок��е с��одс����во с ор��гинальным го��осом)
  ...
  const speakSystemDiagnostics = () => {
    ...
    firstAudio.onended = () => {
      ...
      setTimeout(() => {
        ...
        secondAudio.onended = () => {
          console.log("✅ Второе ауди�� ��акончилось, диагностика завершена");
          resetState();
        };
        secondAudio.onerror = () => {
          resetState();
  ...
  const processVoiceCommand = (command: string) => {
    ...
    if (
      ...
      command.includes("ве��ни обычную тему") ||
    ...
    // К��манда "Джарвис давай продолжим" - воспроизводит первое аудио
    if (
    ...
    if (
      command.includes("доброе утро джарв��с") ||
    ...
    // Команда "Как дела" (общая, б��з имени �����а��вис)
    if (
    ...
    if (
      ...
      if (
        ...
        console.log("✅ Ус��ов���� выполнены, ����п���ск��ем диа��ностику");
    ...
    if (
      ...
      command.includes("базовый в корзи��у") ||
