...
export default function VoiceControl({
  ...
  useEffect(() => {
    ...
    }, 2000); // Пров��ряем каждые 2 се��унды (чаще для лучшей отзывчивости)
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 500) {
          ...
          console.log("Voice ID не найден, используем браузер��ый TTS");
    ...
    if ("speechSynthesis" in window) {
      ...
      if (jarvisLikeVoice) {
        ...
        if (anyVoice) {
          ...
          utterance.lang = "ru-RU"; // Всегд�� русск��й язык
        }
    ...
    firstAudio.onended = () => {
      ...
      setTimeout(() => {
        ...
        secondAudio.onerror = () => {
          resetState();
          console.error(
            "❌ Оши��ка во��произ��едени�� второго ау��ио ��иагности��и",
          );
        };
  ...
  const processVoiceCommand = (command: string) => {
    ...
    if (
      ...
      command.includes("давай продол��им") ||
    ...
    if (
      ...
      command.includes("наст��ящий джарвис") ||
    ...
    if (
      ...
      command.includes("как дел�� джарвис") ||
    ...
    const meaningfulWords = [
      ...
      "план",
      "джа��вис",
      "жа��вис", // частые ошибки распознавания
      "ярвис",
      "джаров",
      "базовый",
      "про",
    ...
    // Умны�� поиск ��онтента по всему сайту
    ...
    if (
      command.includes("п��окрутить ввер��") ||
    ...
    <div className={inNavbar ? "relative" : "fixed bottom-6 right-6 z-50"}>
      ...
      >
        ...
        <div className="text-xs text-white/60 text-center">
          {isSpeaking ? "��оворю..." : isListening ? "Слушаю..." : "ДЖАРВИС"}
        </div>
      </div>
