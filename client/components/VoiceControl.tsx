...
export default function VoiceControl({
  ...
  const startListening = useCallback(() => {
    ...
    try {
      ...
      recognition.onend = () => {
        ...
        // Если не обрабатываем команд�� и не играет аудио, перезапускаем микрофон с большей задержкой
  ...
  const handleVoiceCommand = useCallback((command: string) => {
    ...
    if (lowerCommand.includes("пятница")) {
      // Здесь можно отправить команду в ��ат с Пятницей
