...
export default function VoiceControl({
  ...
  // Функ��ия дл�� полного сброса Speech Recognition
  ...
  const speakShutdown = () => {
    ...
    setTimeout(() => {
      ...
      const shutdownComplete = () => {
        ...
        currentAudioRef.current = null;
        setTranscript("");
        // НЕ открыва��м панель ��братно после коман��ы отключения
        console.log(
  ...
  const speakHowAreYou = () => {
    ...
    if ("speechSynthesis" in window) {
      ...
      utterance.lang = "en-US"; // ����г��ийский для лучшего качества, потом переклю�����им ���� русский
  ...
  const processVoiceCommand = (command: string) => {
    ...
    // Команда "Джарвис вер��и меня обратно" - возврат к обычной теме
    if (
    ...
    if (
      ...
      console.log("👋 Команда приветствия расп��знана:", command);
      speakWelcomeBack();
      return;
    }
    ...
    if (
      ...
      command.includes("полную диагностику си��тем") ||
