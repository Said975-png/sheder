...
export default function VoiceControl({
  ...
  useEffect(() => {
                  ...
                  setTimeout(() => {
                    ...
                    if (recognitionRef.current && isListening) {
                      ...
                      try {
                        ...
                        console.log("Ошибка переза��уска Recognition:", error);
                      }
                    }
                  }, 2000);
                },
    ...
    return () => {
      ...
      // Оста��авливаем любое воспроизводящееся аудио при размонтировании
  ...
  const speakWithElevenLabs = async (text: string) => {
    ...
    // Оста��авливаем любое текущее воспроизведе��ие
    if (currentAudioRef.current) {
      currentAudioRef.current.pause();
      currentAudioRef.current.currentTime = 0;
    }
  ...
  const speakAuthenticJarvis = () => {
    ...
    // НЕ останавливаем распознавание во время воспроизведения ауди��
