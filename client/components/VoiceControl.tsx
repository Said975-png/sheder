...
export default function VoiceControl({
            ...
            if (
              ...
              commandDelayRef.current = setTimeout(
                () => {
                  ...
                  setNoSpeechCount(0); // Сб��асываем счетчик пр�� ус��ешном ра�����ознавании
        ...
        recognitionRef.current.onerror = (event) => {
          ...
          // Некри��и��еские ��шибки - игнорируе�� и ��родолж������ем
            ...
            if (event.error === "no-speech") {
              ...
              console.log(
                "ℹ️ Некритиче��кая ошибк�� ��аспознава��ия:",
                event.error,
                "- ��ро��ол��аем слушать",
              );
            }
  ...
  const speakRotateModel = () => {
    // Улучшенная защ��та - разрешаем если нет активного ауд��о
    if (isSpeaking && audioPlayingRef.current) {
  ...
  const activateStarkLab = () => {
    ...
    firstAudio.onerror = () => {
      ...
      console.error("❌ Ошибка вос��роизведения первог�� а��дио акти��ации");
    };
  ...
  const processVoiceCommand = (command: string) => {
    ...
    // КРОМЕ команды отключения, котор��я обрабатывается отд��льно
    ...
    // Команда "Джарвис, полная активация" - ак��ивация лаборатории Старка
    if (
    ...
    if (
      ...
      console.log(
        "🎯 Команда приветствия распознана, време���� прошло:",
