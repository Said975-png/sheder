...
export default function VoiceControl({
      ...
      if (recognitionRef.current) {
        ...
        if (
          ...
          try {
            ...
            recognitionRef.current.webkitSpeechInputMinimumLengthMS = 500; // Минимальная длина запи��и
          ...
          navigator.mediaDevices
            ...
            .then((stream) => {
              ...
              if (audioTracks.length > 0) {
                ...
                console.log("🔧 Возможности микроф��на:", capabilities);
        ...
        recognitionRef.current.onresult = (event) => {
          ...
          // Фильтруем повторяющиеся фразы и слишком длинные р��зультаты
        ...
        recognitionRef.current.onerror = (event) => {
          ...
          // Некри��и��еские ��шибки - игнорируе�� и ��родолж��������ем
            ...
            if (event.error === "no-speech") {
              ...
              // Есл���� сл��шк��м мн��го no-speech о��ибок ��одряд, делаем неб��льшую паузу
              if (noSpeechCount >= 3) {
                console.log(
  ...
  // Фу��кция дл�� пол��ого ��броса состояния по���ле ��оманды
  ...
  const speakShutdown = () => {
    ...
    if (currentAudioRef.current) {
      console.log("⏹�� Останавливае�� т��кущее аудио");
      currentAudioRef.current.pause();
      currentAudioRef.current.currentTime = 0;
  ...
  const speakWelcomeBack = () => {
    if (isSpeaking) {
      console.log("🚫 speakWelcomeBack за��л��киро��ан - уже играет ау��ио");
      return;
    }
  ...
  const speakGoodMorning = () => {
    ...
    audio.onerror = () => {
      resetState();
      console.error(
        "О��ибка во����произведения ауди�� утрен��е��о при����етствия",
      );
    };
  ...
  const speakAuthenticJarvis = () => {
    ...
    // Немед��ен����о очищаем транскрипт к��гда н��чинаем гово��ит��
    setTranscript("");
    ...
    console.log("🔊 Воспр��из��о���им аудио, но остав��яем микрофон активным");
  ...
  const speakHowAreYou = () => {
    ...
    if ("speechSynthesis" in window) {
      ...
      if (jarvisLikeVoice) {
        ...
        utterance.rate = 0.7; // Е����е м��дленне�� ��ля большей солидно��ти
      }
  ...
  const activateStarkLab = () => {
    ...
    firstAudio.onended = () => {
      ...
      }, 1000); // З��держка 1 секунда для завершения анимации
    };
  ...
  const deactivateStarkLab = () => {
    ...
    const resetState = () => {
      ...
      console.log("✅ В��зв��ат к обычно�� теме заве��шен");
    };
  ...
  const processVoiceCommand = (command: string) => {
    ...
    // При��удитель��о сбрасы��ае�� все блокировки перед обработкой новой ����оманды
    ...
    if (
      ...
      // Принудительно выполн��ем ко��анду отключени�� независимо от сост��яния
      speakShutdown();
      return;
    }
    ...
    // Команда привет��твия "��ривет Джарвис" - улуч��енное распознавание с защитой от повторов
    if (
    ...
    if (
      ...
      command.includes("��жарвис я тебя люблю") ||
    ...
    if (
      ...
      // Если ни��его спе��ифичног����� ��е найдено, поп��обуе�� общий ��оиск
      if (!found) {
    ...
    if (
      ...
      command.includes("��ар��гистрироваться")
    ) {
      navigate("/signup");
      speak("П��рех��дим к регистрации");
      return;
    }
    ...
    if (
      ...
      // Нахо��им и нажимае�� ��но��ку ко��з����ны
    ...
    if (
      ...
      command.includes("ма��симальный план") ||
    ...
    if (
      ...
      const found = searchAndNavigate(
        ["пл��н", "тариф", "ц����", "pricing", "стоимость"],
        () => {
          const pricingSection = document.querySelector(
            '[data-section="pricing"]',
          );
