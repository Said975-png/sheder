...
export default function VoiceControl({
  ...
  const speakGoodMorning = () => {
    ...
    const resetState = () => {
      ...
      setTimeout(() => {
        commandCooldownRef.current = false;
        lastCommandRef.current = "";
      }, 2000); // Увеличен ��ай����ут до 2 секунд
    };
  ...
  const speakHowAreYou = () => {
    ...
    if ("speechSynthesis" in window) {
      ...
      if (jarvisLikeVoice) {
        ...
        // Fallback: любой доступный го����о�� с оптимиз��рованны��и настройк��ми
  ...
  const processVoiceCommand = (command: string) => {
    ...
    if (
      ...
      command.includes("джарвис друга�� модель") ||
    ...
    if (
      ...
      console.log(
        "🎯 Команда приветствия распознана, времени пр��шло:",
