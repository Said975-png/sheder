...
export default function VoiceControl({
  ...
  const speakAuthenticJarvis = () => {
    ...
    console.log("🔊 Воспр��изво��им аудио, но оставляем микрофон активным");
  ...
  const processVoiceCommand = (command: string) => {
    ...
    if (
      ...
      // Дополнительная проверка + защита от повторов (минимум 10 секунд м��жду приветс��виями)
      if (
        !isSpeaking &&
        !commandCooldownRef.current &&
        !audioPlayingRef.current &&
        ...
        console.log("❌ Приветствие заблокиров��но:", {
          isSpeaking,
          commandCooldown: commandCooldownRef.current,
          audioPlaying: audioPlayingRef.current,
          timeSinceLastGreeting,
