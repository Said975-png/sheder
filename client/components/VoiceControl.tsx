...
export default function VoiceControl({
  ...
  const processVoiceCommand = (command: string) => {
    ...
    if (
      ...
      // ��лучшенная проверка - разрешаем если нет активного аудио
      if (!isSpeaking || !audioPlayingRef.current) {
        deactivateStarkLab();
      }
      return;
    ...
    if (
      ...
      command.includes("ярвис полный доступ")
    ) {
    ...
    if (
      ...
      // До��о��нит�����льна�� проверка, ч��обы избе��������ть повторных ср��батываний
    ...
    if (
      ...
      // ��������олни��ельная провер���а, ��тобы избежать повторных срабат��ва���ий
      if (
        !isSpeaking &&
        !commandCooldownRef.current &&
        !audioPlayingRef.current
