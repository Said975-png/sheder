...
export default function VoiceControl({
    ...
    if ("webkitSpeechRecognition" in window || "SpeechRecognition" in window) {
      ...
      if (recognitionRef.current) {
        ...
        recognitionRef.current.onresult = (event) => {
          ...
          // Ком��нда отключения имеет абсолютный приоритет и выполняется всегда
              ...
              commandDelayRef.current = setTimeout(
                () => {
                  ...
                  setTimeout(() => {
                    ...
                    console.log(
                      "✅ ��ос��ояние оч��щено, Recognition продолжает работать",
                    );
                  }, 2000);
                },
  ...
  const speak = (text: string) => {
    ...
    audio.onerror = () => {
      ...
      console.error("Ошибка в��спроизведения ауди��");
    };
  ...
  const speakWithElevenLabs = async (text: string) => {
    ...
    try {
      // Используем ElevenLabs API ��ля синте��а речи с вашим ��ас��омным голосом
  ...
  const speakAuthenticJarvis = () => {
    ...
    // Используем ваш ��ригиналь��ы�� аудиофайл Джа��виса
    const audio = new Audio(
  ...
  const speakHowAreYou = () => {
    ...
    if ("speechSynthesis" in window) {
      ...
      // Stability: 20 (низкая ст��бильно��ть для более естест��е��ной речи)
  ...
  const activateStarkLab = () => {
    ...
    firstAudio.play().catch((error) => {
      ...
      console.error(
        "❌ Не удал��с�� воспроизвести перво�� аудио активации:",
        error,
      );
    });
  };
  ...
  const processVoiceCommand = (command: string) => {
    ...
    if (
      ...
      console.log("🔬 Команда активации лаборатории р��спознана:", command);
    ...
    if (
      ...
      command.includes("голос дж��рвиса") ||
    ...
    // Команда приветствия "��ривет Джарвис" - улучшенное распознавание с защитой от повторов
    if (
    ...
    if (
      ...
      command.includes("жарвис ка�� дела") || // частые ошибки ра�����ознавани��
    ...
    // Умный поиск контент�� по всему сайту
