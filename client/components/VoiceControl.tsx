...
export default function VoiceControl({
        ...
        recognitionRef.current.onresult = (event) => {
          ...
          if (
            ...
            if (
              ...
              ); // Мень��е з����ержки дл�� фи��альных резул��татов
            } else {
        ...
        recognitionRef.current.onerror = (event) => {
          ...
          // Некри��и��еские ошибки - игнорируе�� и ��родолж������ем
            ...
            if (event.error === "no-speech") {
              ...
              console.log(
                `ℹ️ No-speech о��ибка #${noSpeechCount + 1} - п����од��лж��ем ��лу��ать`,
              );
  ...
  const resetCommandState = (
    ...
    setTimeout(() => {
      ...
      if (isListening && !skipPanelReopen) {
        ...
        console.log("✅ Cooldown сброшен, микр�����он активен");
      } else {
        console.log(
  ...
  const speakHowAreYou = () => {
    // У��учшенная защита - разрешаем если нет активного аудио
    if (isSpeaking && audioPlayingRef.current) {
    ...
    if ("speechSynthesis" in window) {
      ...
      // Similarity Boost: 90 (высок��е сходс����во с ор��гинальным голосом)
  ...
  const speakContinue = () => {
    ...
    audio.onerror = () => {
      resetState();
      console.error("❌ Ошибка воспроизведе��ия первого аудио");
    };
  ...
  const activateStarkLab = () => {
    ...
    firstAudio.onended = () => {
      ...
      setTimeout(() => {
        console.log("🔊 Воспроизводим второе аудио после активаци��");
        const secondAudio = new Audio(
  ...
  const processVoiceCommand = (command: string) => {
    ...
    // ГАРА��ТИРОВ��ННАЯ защита от зас��ревания: всегда разрешаем обработку новых к��манд
    ...
    if (
      command.includes("джарвис я ��ернулся") ||
    ...
    // Команды для оригинального голоса Джарвиса (из фильм��)
    if (
    ...
    // Команда приветствия "Привет Джарвис" - улучшенное распознавание с защитой от пов��оров
    if (
    ...
    if (
      ...
      command.includes("полную ��иагностику систем") ||
    ...
    if (
      ...
      if (
        ...
        found = searchAndNavigate(["компан", "�� н��с", "about", "кто мы"]);
        if (found) {
    ...
    console.log("🔄 Сбрасываем состояни�� для следующей команды");
