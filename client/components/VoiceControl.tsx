...
export default function VoiceControl({
  ...
  const processVoiceCommand = (command: string) => {
    ...
    // Команды ��ля оригинального голоса Джарвиса (��з фи��ьма)
    if (
    ...
    // Команда "Джарвис как дела" с ��тветом "Все системы ф��нкционируют нормально"
    if (
    ...
    if (
      ...
      if (
        ...
        if (found) {
          speak("П��казываю информацию о ка��естве");
          return;
        }
      }
    ...
    if (
      ...
      command.includes("п��казать корзину") ||
