    ...
    if ("webkitSpeechRecognition" in window || "SpeechRecognition" in window) {
      ...
      if (recognitionRef.current) {
          ...
          navigator.mediaDevices
            .getUserMedia({
              audio: {
                ...
                sampleRate: 48000, // Максимальное качество записи
        ...
        recognitionRef.current.onresult = (event) => {
          ...
          // Показываем промежуточны�� результат с пониженным порогом для дальнег�� распознавания
          if (
            combinedTranscript &&
