...
export default function VoiceControl({
    ...
    if ("webkitSpeechRecognition" in window || "SpeechRecognition" in window) {
      ...
      if (recognitionRef.current) {
        ...
        recognitionRef.current.onresult = (event) => {
          ...
          // Проверяем на п��вторя��щиеся слова (признак на��о��ле��и��)
          ...
          if (
            ...
            if (
              ...
              // Добавляем небольшую ��ад��ржку для завершения фр��зы
  ...
  const resetCommandState = (
    ...
    console.log(`⏰ П��ан��руем ��брос cooldown через ${delay}мс`);
    setTimeout(() => {
  ...
  const speakShutdown = () => {
    console.log("���� Выполняем команд�� от��лючения микр��фо��а");
  ...
  const speakFullAccess = () => {
    ...
    audio.onerror = () => {
      ...
      console.error("Ошибка воспроизве��ения аудио п��лного доступа");
    };
  ...
  const speakSystemDiagnostics = () => {
    ...
    firstAudio.play().catch((error) => {
      resetState();
      console.error(
        "❌ Не удалось в��спроизве��ти пе��вое аудио диагностики:",
        error,
      );
    });
  };
  ...
  const processVoiceCommand = (command: string) => {
    ...
    if (
      command.includes("джарвис ��ерни меня обратно") ||
    ...
    if (
      ...
      command.includes("джарвис я зде��ь") ||
    ...
    // Команда "Джарвис давай продолжим" - воспроизводит первое ауд��о
    if (
