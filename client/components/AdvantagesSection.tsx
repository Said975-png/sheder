...
const advantages: Advantage[] = [
  {
    ...
    description:
      "Создаем неповторимые веб-сайты с потрясающим визуальным оформлением",
  ...
  },
  {
    ...
    description:
      "Внедряем передовые AI-технологии для умных и интерактивных решений",
  ...
  },
  {
    ...
    description:
      "Погружаем пользователей в мир трехмерных интерактивных элементов",
  ...
  },
  {
    ...
    description:
      "Реализуем любые функции, которые вы хотите видеть на своем сайте",
    ...
    <section className="relative py-20 px-4 overflow-hidden bg-gradient-to-br from-black via-gray-900 to-black">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
            ...
            {advantages.map((advantage, index) => (
              ...
              >
                <div className="text-center">
                  ...
                  >
                    <div className="text-white scale-75">{advantage.icon}</div>
                  </div>
        ...
        <div className="text-center mt-16">
          <Button className="px-8 py-4 text-lg font-semibold bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-400 hover:to-purple-500 text-white rounded-full shadow-lg hover:shadow-cyan-400/25 transition-all duration-300 transform hover:scale-105 font-mono">
