...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 bg-black/80 backdrop-blur-lg border border-cyan-400/30 rounded-full px-4 py-2 stark-glow">
        <div className="flex items-center space-x-3">
          {/* Home Button */}
          <Button
            variant="ghost"
            className="text-sm px-4 py-2 rounded-full hover:bg-cyan-400/10 transition-all duration-300 font-mono"
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold mb-6">
              Why{" "}
              <HologramText glitch>Blockchain?</HologramText>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Decentralization */}
            <StarkHUD className="bg-black/60 backdrop-blur-sm p-6 hover:bg-black/80 transition-all duration-500 group relative overflow-hidden cursor-pointer">
              ...
              <div className="w-16 h-16 bg-cyan-400/10 border border-cyan-400/30 rounded-lg flex items-center justify-center mb-6 group-hover:bg-cyan-400/20 group-hover:border-cyan-400/50 transition-all duration-300 relative mx-auto">
                <Layers className="w-8 h-8 text-cyan-400" />
                <div className="absolute inset-0 bg-cyan-400/5 rounded-lg animate-pulse"></div>
              </div>
              <h3 className="text-xl font-bold mb-4 text-cyan-400 uppercase tracking-wider text-center font-mono">
                [ DECENTRALIZATION ]
              </h3>
              <p className="text-white/70 text-sm text-center">
                Distributed network architecture • No single point of failure
              </p>
              <div className="mt-4 text-xs text-cyan-400/60 uppercase tracking-widest text-center font-mono">
                STATUS: ACTIVE
              </div>
            </StarkHUD>
            ...
            <StarkHUD className="bg-black/60 backdrop-blur-sm p-6 hover:bg-black/80 transition-all duration-500 group relative overflow-hidden cursor-pointer">
              ...
              ></div>
              <div className="w-16 h-16 bg-blue-400/10 border border-blue-400/30 rounded-lg flex items-center justify-center mb-6 group-hover:bg-blue-400/20 group-hover:border-blue-400/50 transition-all duration-300 relative mx-auto">
              ...
              <h3 className="text-xl font-bold mb-4 text-blue-400 uppercase tracking-wider text-center font-mono">
                [ SECURITY ]
              </h3>
              <p className="text-white/70 text-sm text-center">
                Cryptographic protocols • Immutable data structures
              </p>
              <div className="mt-4 text-xs text-blue-400/60 uppercase tracking-widest text-center font-mono">
