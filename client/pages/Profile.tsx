              ...
              <CardContent className="text-center">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="secondary" className="bg-white/10 text-white">{currentUser.id}</Badge>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-white/70">Дата регистрации:</span>
                    <span className="text-white">{formatDate(JSON.parse(localStorage.getItem('users') || '[]').find((u: User) => u.id === currentUser.id)?.createdAt || new Date().toISOString())}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                {activeTab === 'security' && (
                  <div className="space-y-6">
                    <form onSubmit={handlePasswordChange} className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="newPassword" className="text-white/80">Новый пароль</Label>
                        <div className="relative">
                          <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-white/50" />
                          <Input
                            id="newPassword"
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="confirmPassword" className="text-white/80">Подтвердите новый пароль</Label>
                        <div className="relative">
                          <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-white/50" />
                          <Input
                            id="confirmPassword"
